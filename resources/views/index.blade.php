    ...
    <img src="" alt="">
      ...
      <form class="" action="index.html" method="post">
        ...
        <div class="my-8">
          ...
          <label for="doc-or-hospital">Doctor / hospital </label>
          <input type="radio" name="doc-or-hospital" value="">
          <label for="principal-member">Principal member </label>
          <input type="radio" name="principal-member" value="no">
          <label for="patient">Patient</label>
          <input type="radio" name="patient" value="no">
          <label for="group">Group (if on a company plan)</label>
          <input type="radio" name="group" value="no">
          <b>Please complete either Section A or Section B </b><br>
          <b>Section A - Payment by cheque</b><br>
          <div class="">
            <b>In which currency would you like us to pay the cheque? (please tick one only)</b><br>
            <label for="invoice-currency">Currency of your invoices </label>
            <input type="radio" name="invoice-currency" value="">
            <label for="subscription-currency">Currency of your subscriptions </label>
            <input type="radio" name="subscription-currency" value="no">
            <label for="bank-acc-currency">Currency of your bank account </label>
            <input type="radio" name="bank-acc-currency" value="no">
            <label for="specify-acc">Please specify this: </label>
            <input type="text" name="specify-acc" value="">
            <small>Cheques payable to members will be sent by post to the correspondence address provided on the front page.</small>
          </div>
          <b>Section B - Payment by Electronic Funds Transfer to a bank account </b><br>
          <label for="bank-name">Bank name</label>
          <input type="text" name="bank-name" value="">
          <label for="swift">SWIFT / BIC code *</label>
          <input type="text" name="swift" value="">
          <label for="sort-code">Sort code (UK only): </label>
          <input type="text" name="sort-code" value="">
          <label for="acc-number">Account number</label>
          <input type="text" name="acc-number" value="">
          <label for="iban">IBAN</label>
          <input type="text" name="iban" value="">
          <label for="acc-name">Account name/ payee: </label>
          <input type="text" name="acc-name" value="">
          <label for="transfer-currency">Currency for the transfer: </label>
          <input type="radio" name="transfer-currency" value="no">
          <label for="bank-address">Bank address: </label>
          <input type="text" name="bank-address" value="">
          <label for="post-zip">Post / Zip code: </label>
          <input type="text" name="post-zip" value="">
        ...
        <div class="">
          <h3>YOUR CONSENT TO OBTAIN A MEDICAL REPORT </h3>
          <h4 class="text-center">IMPORTANT INFORMATION</h4>
          <div class="">
            <p>Please read this section carefully, as it sets out your rights under the Access to Medical Reports Act 1988 and the  Access to Personal Files and Medical Reports (NI) Order 1991. </p>
            ...
            <ul>
              <ol>You can give your consent without asking to see the doctor’s report before it is sent to us. The report  will then be sent directly to us by the doctor. </ol>
              <ol>
...
Should you give your consent to us obtaining a report without indicating that you wish to see it, you  can change your mind by contacting your doctor before the report is sent to us, in which case you will  have the opportunity to see the report and ask the doctor to change the report or add your comments  before it is sent to us, or withhold your consent for its release.
          ...
          <div class="">
            <h3 class=""> THIRD PARTY INSURERS </h3>
            <p>Are some of the costs recoverable from someone else (for example, state insurer or a person / organisation involved in an accident?):</p>
            ...
            <input type="text" name="insurer-name" value="">
            <label for="hospital-address">Address</label>
            <input type="text" name="insurer-address" value="">
            <label for="hospital-email">Email</label>
            <input type="text" name="insurer-email" value="">
            <label for="telephone">Telephone</label>
            <input type="tel" name="insurer-tel" placeholder="256700100100" value="">
          </div>
          <div class="">
            <h3 class="">DECLARATION</h3>
            <h4>IMPORTANT INFORMATION - TO BE COMPLETED BY THE PATIENT</h4>
            <div class="">
              <div class="">
                <p>I confirm that the information I have given on this form is  accurate and correct, to the best of my knowledge. </p>
                <input type="text" name="confirm-info" value="" placeholder="Patient’s signature (Parent or guardian if patient is under 16)">
              </div>
              <div class="">
